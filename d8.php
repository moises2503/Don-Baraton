...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/club.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/sueter3.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/club.png" alt="">
    </div>
    ...
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/sueter3.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/club.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2> Fede Chamarra Universitaria
        </h2>
