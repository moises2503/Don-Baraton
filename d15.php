...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/playera5.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/c.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/v.png" alt="">
    </div>
    ...
    <img src="img/playera5.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/c.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/v.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Playera Cuello De Tortuga
        </h2>
          <p class="product-color"><strong>Color:</strong> Cafe, verde</p>
...
38
          ...
          <p class="product-finance"><strong>Financiamiento:</strong>
7% OFF
en 24 meses de 
$
11
