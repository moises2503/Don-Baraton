...
<body>
  ...
  <header>
    ...
    <ul>
        ...
        <li>
            <a href="Deporte.php">
                ...
                <div class="name"><span data-text="Deporte">Moda</span></div>
            </a>
        </li>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="https://i.pinimg.com/736x/df/a4/46/dfa446dc4a4b67225d47a201cc32cb42.jpg" alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="https://i.pinimg.com/736x/0a/9a/59/0a9a596a96478cc1974b486874b58089.jpg" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="https://i.pinimg.com/736x/9b/59/1f/9b591fb69be5c05d995389da8ded10ee.jpg" alt="">
    </div>
    ...
    <img src="https://i.pinimg.com/736x/df/a4/46/dfa446dc4a4b67225d47a201cc32cb42.jpg" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="https://i.pinimg.com/736x/0a/9a/59/0a9a596a96478cc1974b486874b58089.jpg" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="https://i.pinimg.com/736x/9b/59/1f/9b591fb69be5c05d995389da8ded10ee.jpg" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Samsung Galaxi Ultra 256 Gb</h2>
          <p class="product-color"><strong>Color:</strong> Rosa oscuro/Negro/Turquesa</p>
          <p class="product-price"><strong>Precio:</strong> $20,9999.00</p>
          <p class="product-finance"><strong>Financiamiento:</strong> en 18 meses sin intereses de $1,166,61</p>
