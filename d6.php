...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/sueter1.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/suda.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/suda.png" alt="">
    </div>
    ...
    <img src="img/sueter1.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/suda.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/suda.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Chamarra Deportiva Ajustada Aeroready Sereno
        </h2>
