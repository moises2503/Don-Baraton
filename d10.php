...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/sueter5.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/gorra3.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/gorra4.png" alt="">
    </div>
    ...
    <img src="img/sueter5.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/gorra3.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/gorra4.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>New Era Gorra N Y Yankees Metallic 9forty 
        </h2>
