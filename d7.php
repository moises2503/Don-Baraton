...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/sueter2.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/shendy.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/vendy.png" alt="">
    </div>
    ...
    <img src="img/sueter2.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/shendy.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/vendy.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Deportiva Con Cierre Hoodie
        </h2>
