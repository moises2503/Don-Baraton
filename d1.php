...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/blusas.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/blusas.1.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/blusas.2.png" alt="">
    </div>
    ...
    <img src="img/blusas.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/blusas.1.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/blusas.2.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Paquete 5 Blusas Termicas Para Mujer Manga Larga Afelpada
        </h2>
          <p class="product-color"><strong>Color:</strong>5 diferentes</p>
          <p class="product-price"><strong>Precio:</strong> $468,33
            
           </p>
          <p class="product-finance"><strong>Financiamiento:</strong> 33% OFF en 24 meses de 
            $28,30 IVA incluido</p>
