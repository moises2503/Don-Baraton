...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/playera2.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/blanco1.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/blanco2.png" alt="">
    </div>
    ...
    <img src="img/playera2.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/blanco1.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/blanco2.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Playera De Niño Cuello Ruso
        </h2>
