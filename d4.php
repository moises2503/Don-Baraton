...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/blusa4.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/rosa1.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/verde1.png" alt="">
    </div>
    ...
    <img src="img/blusa4.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/rosa1.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/verde1.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2> Pantalón Vestir Dama Moda
        </h2>
          <p class="product-color"><strong>Color:</strong> Negro, Rosa, Verde</p>
          <p class="product-price"><strong>Precio:</strong> $276
           </p>
