...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/playera3.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/cuello1.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/cuello2.png" alt="">
    </div>
    ...
    <img src="img/playera3.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/cuello1.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/cuello2.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Camisa Cuello Alto Tortuga
        </h2>
          <p class="product-color"><strong>Color:</strong>Cafe, Gris, Blanco</p>
...
44
          ...
          <p class="product-finance"><strong>Financiamiento:</strong> 33 meses sin intereses de 
$
54
,
48</p>
