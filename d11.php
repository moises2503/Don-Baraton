...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/playera1.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/playa.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/playera1.png" alt="">
    </div>
    ...
    <img src="img/playera1.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/playa.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/playera1.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Playera Con Cuello A Rayas
        </h2>
          <p class="product-color"><strong>Color:</strong> Azul y Blanco</p>
