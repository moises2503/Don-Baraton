...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/gris1.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/gris2.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/blusas2.png" alt="">
    </div>
    ...
    <img src="img/gris1.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/gris2.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/blusas2.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Blusa Sueter Dama Moda Casual Elegante Zurama
        </h2>
          <p class="product-color"><strong>Color:</strong> 4 diferentes</p>
...
20
          ...
          <p class="product-finance"><strong>Financiamiento:</strong> 24 meses de 
$
13
,
67
