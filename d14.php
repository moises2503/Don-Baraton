...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/playera4.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/pv.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/pv1.png" alt="">
    </div>
    ...
    <img src="img/playera4.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/pv.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/pv1.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Playera Niños Cuello Redondo 100% Algodón
        </h2>
          <p class="product-color"><strong>Color:</strong> Verde</p>
...
60
          ...
          <p class="product-finance"><strong>Financiamiento:</strong> 328% OFF
IVA incluido
