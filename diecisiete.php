...
<body>
  ...
  <header>
    ...
    <ul>
        ...
        <li>
            <a href="Ofertas.php">
                ...
                <div class="name"><span data-text="Todas las ofertas" >
                    ¡Encuentra precios increíbles cada día! </span></div>
            </a>
        </li>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="https://i.pinimg.com/736x/5e/c1/27/5ec12713e432e5587df0a6bebcdf605d.jpg" alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="https://i.pinimg.com/736x/1a/31/9a/1a319a2d10dea51355a375c8e1f85ecc.jpg" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="https://i.pinimg.com/736x/b2/21/e6/b221e6e682d8720810b681083b017ef3.jpg" alt="">
    </div>
    ...
    <img src="https://i.pinimg.com/736x/5e/c1/27/5ec12713e432e5587df0a6bebcdf605d.jpg" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="https://i.pinimg.com/736x/1a/31/9a/1a319a2d10dea51355a375c8e1f85ecc.jpg" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="https://i.pinimg.com/736x/b2/21/e6/b221e6e682d8720810b681083b017ef3.jpg" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Conjunto Deportivo Dama</h2>
          <p class="product-color"><strong>Color:</strong> Color crema Oscuro/Claro</p>
          <p class="product-price"><strong>Precio:</strong> $639.00</p>
          <p class="product-finance"><strong>Financiamiento:</strong> en 24 meses de $38.61</p>
