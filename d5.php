...
<body>
   ...
   <div class="product-container">
    ...
    <img id="imagenes"src="img/blusas5.png"alt="">
    </div>
    <div class="carousel-item active">
    <img id="imagenes"src="img/s1.png" alt="">
    </div>
    <div class="carousel-item">
    <img id="imagenes"src="img/s2.png" alt="">
    </div>
    ...
    <img src="img/blusas5.png" alt="">
    </button>
    
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="1"><img src="img/s2.png" alt=""></button>
    <button type="button" class="active"
    data-bs-target="#carouselDemo" data-bs-slide-to="2"><img src="img/s2.png" alt=""></button>
        ...
        <div class="product-banner">
          <h2>Ugly Sweater Navideño
        </h2>
          <p class="product-color"><strong>Color:</strong>Rojo</p>
